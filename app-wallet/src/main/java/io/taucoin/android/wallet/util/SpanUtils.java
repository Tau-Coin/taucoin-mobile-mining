...
public final class SpanUtils {
    ...
    public SpanUtils setCornerBackgroundColor(@ColorInt final int color, int filletedCorner) {
        this.backgroundColor = color;
        this.filletedCorner = filletedCorner;
        return this;
    }
...
//            if(filletedCorner > 0){
//                mBuilder.setSpan(new VerticalCenterSpan(0x00000000, backgroundColor, backgroundColor, filletedCorner), start, end, flag);
//            }else{
