...
/** 
 * DAO for table "MINING_BLOCK".
*/
public class MiningBlockDao extends AbstractDao<MiningBlock, Long> {

    public static final String TABLENAME = "MINING_BLOCK";

    /**
     * Properties of entity MiningBlock.<br/>
    ...
    public MiningBlockDao(DaoConfig config) {
        super(config);
    }
    
    public MiningBlockDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MINING_BLOCK\" (" + //
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MiningBlock entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MiningBlock entity) {
        stmt.clearBindings();
    ...
    @Override
    public MiningBlock readEntity(Cursor cursor, int offset) {
        MiningBlock entity = new MiningBlock( //
    ...
    @Override
    public void readEntity(Cursor cursor, MiningBlock entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MiningBlock entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MiningBlock entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MiningBlock entity) {
