package io.taucoin.android.wallet.widget.banner;
...
import io.taucoin.android.wallet.widget.banner.layoutmanager.BannerLayoutManager;
import io.taucoin.android.wallet.widget.banner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        int gradientSize = dp2px(10);
        if (mSelectedDrawable == null) {
            // Draw default selected status graph
            GradientDrawable selectedGradientDrawable = new GradientDrawable();
            selectedGradientDrawable.setShape(GradientDrawable.OVAL);
            selectedGradientDrawable.setColor(ResourcesUtil.getColor(R.color.color_yellow));
            selectedGradientDrawable.setSize(gradientSize, gradientSize);
            selectedGradientDrawable.setCornerRadius(gradientSize / 2);
            mSelectedDrawable = new LayerDrawable(new Drawable[]{selectedGradientDrawable});
        }
        if (mUnselectedDrawable == null) {
            // Draw default unchecked status graph
            GradientDrawable unSelectedGradientDrawable = new GradientDrawable();
            unSelectedGradientDrawable.setShape(GradientDrawable.OVAL);
            unSelectedGradientDrawable.setColor(ResourcesUtil.getColor(R.color.color_grey));
            unSelectedGradientDrawable.setSize(gradientSize, gradientSize);
            unSelectedGradientDrawable.setCornerRadius(gradientSize / 2);
    ...
    // Set whether scrolling is prohibited
    ...
    // Set the moving speed to follow your finger
    ...
    /**
     * Setting the Interval Time of Rotary Planting
     *
    ...
    /**
     * Set whether to play automatically (lock)
     *
