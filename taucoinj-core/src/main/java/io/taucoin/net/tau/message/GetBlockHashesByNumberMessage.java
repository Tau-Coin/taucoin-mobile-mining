 ...
 *
 * @see TauMessageCodes#GET_BLOCK_HASHES_BY_NUMBER
 *
 * @author Mikhail Kalinin
 * @since 18.08.2015
 */
public class GetBlockHashesByNumberMessage extends TauMessage {
    ...
    public TauMessageCodes getCommand() {
        return TauMessageCodes.GET_BLOCK_HASHES_BY_NUMBER;
    }
