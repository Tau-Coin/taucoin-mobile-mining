package io.taucoin.net.swarm;

import io.taucoin.net.rlpx.Node;
import io.taucoin.net.rlpx.discover.table.NodeEntry;
import io.taucoin.net.rlpx.discover.table.NodeTable;
import io.taucoin.net.swarm.bzz.BzzHandler;
import io.taucoin.net.swarm.bzz.BzzPeersMessage;
import io.taucoin.net.swarm.bzz.BzzProtocol;
import io.taucoin.net.swarm.bzz.PeerAddress;
...
//            ret.add(thisPeer.getPeer(new PeerAddress(node)));
     ...
     *  ({@link io.taucoin.net.swarm.Hive.HiveTask#expireTime} and a limited number of
     *  peers to process ({@link io.taucoin.net.swarm.Hive.HiveTask#maxPeers}).
