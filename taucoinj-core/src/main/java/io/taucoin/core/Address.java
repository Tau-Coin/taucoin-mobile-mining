...
/**
 * <p>A taucoin address looks like TMsScoe2fTJoq4ZPdQgqyhgWeoNamYPevy and is derived from an elliptic curve public key
...
public class Address extends VersionedChecksummedBytes {
    ...
    public Address(NetworkParameters params, int version, byte[] hash160) /*throws WrongNetworkException*/{
        ...
        if ( version !=65 && !isAcceptableVersion(params, version))
