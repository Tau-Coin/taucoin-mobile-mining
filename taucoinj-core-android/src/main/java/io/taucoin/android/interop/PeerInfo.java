...
public class PeerInfo extends io.taucoin.net.peerdiscovery.PeerInfo implements Parcelable {
    ...
    public PeerInfo(io.taucoin.net.peerdiscovery.PeerInfo peerInfo) {
