...
package io.taucoin.android.secp256k1;
...
import static io.taucoin.android.secp256k1.NativeSecp256k1Util.*;
...
public class NativeSecp256k1 {
	...
	/**
     * libsecp256k1 recover a pubkey from an ECDSA signature.
     *
     * @param data Message hash, 32 bytes
     * @param recovery sig, 65 bytes
     *
     * Return values
    ...
    public static byte[] recoverPubkey(byte[] data, byte[] sig) throws AssertFailException{
        ...
        int pubkeyLen = new BigInteger(new byte[] { retByteArray[1][0] }).intValue();
        int retVal = new BigInteger(new byte[] { retByteArray[1][1] }).intValue();
    ...
    private static native byte[][] secp256k1_ecdsa_recover(ByteBuffer byteBuff, long context, int siglen);
