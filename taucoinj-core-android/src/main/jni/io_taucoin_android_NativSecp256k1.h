...
/* Header for class io_taucoin_android_NativeSecp256k1 */

#ifndef _Included_io_taucoin_android_NativeSecp256k1
#define _Included_io_taucoin_android_NativeSecp256k1
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     io_taucoin_android_NativeSecp256k1
 ...
 * Signature: (Ljava/nio/ByteBuffer;JI)[[B
 */
SECP256K1_API jobjectArray JNICALL Java_io_taucoin_android_NativeSecp256k1_secp256k1_1ec_1pubkey_1parse
  (JNIEnv *, jclass, jobject, jlong, jint);
